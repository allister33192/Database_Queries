  ...
  <table class="menu">
    <tr>
      ...
      <td background="http://web.engr.oregonstate.edu/~hahnl/final_project/images/background_image.png">
        <div align="left">
          <b>Share Favorite Recipes with Friends!</b><br>
          &nbsp; <img src="http://web.engr.oregonstate.edu/~hahnl/final_project/images/bullet.png"><button onclick="window.location.href='share.php?username=<?php echo $username ?>'">Click Here for Link to Share</button>
          <br><br>
          &nbsp; <img src="http://web.engr.oregonstate.edu/~hahnl/final_project/images/bullet.png"><button onclick="window.location.href='http://www.facebook.com/sharer.php?u=http://web.engr.oregonstate.edu/~hahnl/final_project/share.php?username=<?php echo $username ?>'">Share On Facebook</button>
        </div>
      </td>
...
<br>
   <div align="center">
   <button onClick="window.close()">Close Favorites</button>
 </div>
</div>
</body>
</html>
